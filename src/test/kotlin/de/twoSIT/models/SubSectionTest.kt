...
val node1 = Node("1", 0.0, 0.0, mutableMapOf())
val node2 = Node("2", 1.0, 0.0, mutableMapOf())
val node3 = Node("3", 2.0, 0.0, mutableMapOf())
...
val node1 = Node("1", 0.0, 0.0, mutableMapOf())
val node2 = Node("2", 1.0, 0.0, mutableMapOf())
val node3 = Node("3", 0.5, 0.5, mutableMapOf())
val subsection = SubSection(node1, node2)
...
val expectedNode = Node("-1", 0.5, 0.0, mutableMapOf())
val expectedT = 0.5
...
val node1 = Node("1", 51.0255184, 13.7223363, mutableMapOf())
val node2 = Node("2", 51.0255451, 13.7221857, mutableMapOf())
val node3 = Node("3", 51.0255614, 13.7222899, mutableMapOf())
val subsection = SubSection(node1, node2)
...
val expectedNode = Node("-1", 51.0255, 13.7222, mutableMapOf())
val expectedT = 0.35
