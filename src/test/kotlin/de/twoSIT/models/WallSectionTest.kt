...
class WallSectionTest {
    ...
    fun testGetIntersectionNodeIsNull() {
        ...
        val node1 = IndoorObject("1", 0.0, 0.0, mutableListOf(1), mutableMapOf())
        val node2 = IndoorObject("2", 1.0, 0.0, mutableListOf(1), mutableMapOf())
        val node3 = IndoorObject("3", 2.0, 0.0, mutableListOf(1), mutableMapOf())
    ...
    fun testGetIntersectionNodeFarFromIntersectionPoint() {
        ...
        val node1 = IndoorObject("1", 0.0, 0.0, mutableListOf(1), mutableMapOf())
        val node2 = IndoorObject("2", 1.0, 0.0, mutableListOf(1), mutableMapOf())
        val node3 = IndoorObject("3", 0.5, 0.5, mutableListOf(1), mutableMapOf())
        val wallSection = WallSection(node1, node2)
        ...
        val expectedNode = IndoorObject("-1", 0.5, 0.0, mutableListOf(1), mutableMapOf())
        val expectedT = 0.5
    ...
    fun testGetIntersectionNodeCloseToProjectionPoint() {
        ...
        val node1 = IndoorObject("1", 51.0255184, 13.7223363, mutableListOf(1), mutableMapOf())
        val node2 = IndoorObject("2", 51.0255451, 13.7221857, mutableListOf(1), mutableMapOf())
        val node3 = IndoorObject("3", 51.0255614, 13.7222899, mutableListOf(1), mutableMapOf())
        ...
        val expectedNode = IndoorObject("-1", 51.0255, 13.7222, mutableListOf(1), mutableMapOf())
        val expectedT = 0.35
